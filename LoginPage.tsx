...
export function LoginPage({ onLogin, onSwitchToSignup }: LoginPageProps) {
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2">
      ...
      <div className="hidden lg:flex items-center justify-center bg-gradient-to-br from-purple-600 via-blue-600 to-pink-600 p-12 relative overflow-hidden">
        <motion.div
        ...
        <div className="relative z-10 text-white text-center max-w-md">
          ...
          >
            Continue your journey towards truth and clarity
          </motion.p>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center p-6 sm:p-12">
        ...
        >
          ...
          <div className="mb-8">
            <h2 className="text-3xl mb-2 hidden lg:block">Sign In</h2>
          ...
          <div className="mt-8">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              <Button variant="outline" className="rounded-xl glass-panel border-2">
